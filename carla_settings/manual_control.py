...
"""
Welcome to CARLA manual control with steering wheel Logitech G290.
...
class DualControl(object):
    def __init__(self, world, start_in_autopilot):
        ...
        self._steer_idx = int(
            self._parser.get('G290 Racing Wheel', 'steering_wheel'))
        self._throttle_idx = int(
            self._parser.get('G290 Racing Wheel', 'throttle'))
        self._brake_idx = int(self._parser.get('G290 Racing Wheel', 'brake'))
        self._reverse_idx = int(self._parser.get('G290 Racing Wheel', 'reverse'))
        self._handbrake_idx = int(
            self._parser.get('G290 Racing Wheel', 'handbrake'))
